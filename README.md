...
- Cấu trúc thư mục: ứng dụng này yêu cầu một cấu trúc thư mục cụ thể để đọc và ghi dữ liệu. Bạn bắt buộc phải tạo một thư mục tên là data ở thư mục gốc của dự án (ngang hàng với thư mục src).
![img_1.png](img_1.png)
